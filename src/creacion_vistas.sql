...
FROM GLOBALDATA.FLUJO_VIAJEROS_MUNDO AS VIAJEROS_MUNDO
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA ON VIAJEROS_MUNDO.COUNTRY = GEOGRAFIA.NOMBRE_GLOBAL_DATA
GROUP BY 
...
FROM GLOBALDATA.NOCHES_PROMEDIO AS NOCHES_PROMEDIO
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA ON NOCHES_PROMEDIO.COUNTRY = GEOGRAFIA.NOMBRE_GLOBAL_DATA
...
FROM GLOBALDATA.CATEGORIAS_GASTO AS CATEGORIAS_GASTO
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA ON CATEGORIAS_GASTO.COUNTRY = GEOGRAFIA.NOMBRE_GLOBAL_DATA
GROUP BY 
...
FROM GLOBALDATA.RANGO_EDAD AS RANGO_EDAD
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA ON RANGO_EDAD.COUNTRY = GEOGRAFIA.NOMBRE_GLOBAL_DATA
GROUP BY 
    RANGO_EDAD.COUNTRY, 
    GEOGRAFIA.COUNTRY_OR_AREA, 
    RANGO_EDAD.YEAR, 
...
FROM GLOBALDATA.MOTIVO_VIAJE AS MOTIVO_VIAJE
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA ON MOTIVO_VIAJE.COUNTRY = GEOGRAFIA.NOMBRE_GLOBAL_DATA
GROUP BY 
...
FROM GLOBALDATA.FORMA_VIAJE AS FORMA_VIAJE
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA ON FORMA_VIAJE.COUNTRY = GEOGRAFIA.NOMBRE_GLOBAL_DATA
GROUP BY 
    FORMA_VIAJE.COUNTRY, 
    GEOGRAFIA.COUNTRY_OR_AREA, 
    FORMA_VIAJE.YEAR, 
...
SELECT VIAJEROS_REGION.COUNTRY AS PAIS_GLOBALDATA_ORIGEN,
    ...
    CAST(SUM(VIAJEROS_REGION.VALUE) AS BIGINT) AS VIAJEROS
FROM GLOBALDATA.FLUJO_VIAJEROS_REGION AS VIAJEROS_REGION
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA_ORIGEN ON VIAJEROS_REGION.COUNTRY = GEOGRAFIA_ORIGEN.NOMBRE_GLOBAL_DATA
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA_DESTINO ON VIAJEROS_REGION.COUNTRY_OF_ORIGIN_DESTINATION = GEOGRAFIA_DESTINO.NOMBRE_GLOBAL_DATA
GROUP BY VIAJEROS_REGION.COUNTRY, GEOGRAFIA_ORIGEN.COUNTRY_OR_AREA, VIAJEROS_REGION.COUNTRY_OF_ORIGIN_DESTINATION, GEOGRAFIA_DESTINO.COUNTRY_OR_AREA, VIAJEROS_REGION.YEAR
ORDER BY GEOGRAFIA_ORIGEN.COUNTRY_OR_AREA, GEOGRAFIA_DESTINO.COUNTRY_OR_AREA, VIAJEROS_REGION.YEAR ASC;


-- Flujos internacionales por motvo de negocios
...
FROM GLOBALDATA.FLUJO_MICE AS MICE
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA ON MICE.COUNTRY = GEOGRAFIA.NOMBRE_GLOBAL_DATA
GROUP BY 
    MICE.COUNTRY, 
    GEOGRAFIA.COUNTRY_OR_AREA, 
    MICE.YEAR, 
...
SELECT COUNT(DISTINCT IATAGAP_AGENCIAS.TRAVEL_AGENCY_NAME) AS AGENCIAS,
    IATAGAP_AGENCIAS.TRAVEL_AGENCY_COUNTRY,
    GEOGRAFIA_AGENCIA.COUNTRY_OR_AREA AS PAIS_AGENCIA,
    IATAGAP_AGENCIAS.TRIP_ORIGIN_COUNTRY,
    GEOGRAFIA_DEP.COUNTRY_OR_AREA AS PAIS_DEPARTURE,
    IATAGAP_AGENCIAS.TRIP_DESTINATION_COUNTRY,
    GEOGRAFIA_ARR.COUNTRY_OR_AREA AS PAIS_ARRIVAL,
...
WHERE IATAGAP_AGENCIAS.VALUE > 0
GROUP BY IATAGAP_AGENCIAS.TRAVEL_AGENCY_COUNTRY,
    GEOGRAFIA_AGENCIA.COUNTRY_OR_AREA,
    IATAGAP_AGENCIAS.TRIP_ORIGIN_COUNTRY,
    GEOGRAFIA_DEP.COUNTRY_OR_AREA,
    IATAGAP_AGENCIAS.TRIP_DESTINATION_COUNTRY,
    GEOGRAFIA_ARR.COUNTRY_OR_AREA,
    SUBSTR(IATAGAP_AGENCIAS.YEAR, 1, 4)
ORDER BY IATAGAP_AGENCIAS.TRAVEL_AGENCY_COUNTRY,
    GEOGRAFIA_AGENCIA.COUNTRY_OR_AREA,
    IATAGAP_AGENCIAS.TRIP_ORIGIN_COUNTRY,
    GEOGRAFIA_DEP.COUNTRY_OR_AREA,
    IATAGAP_AGENCIAS.TRIP_DESTINATION_COUNTRY,
    GEOGRAFIA_ARR.COUNTRY_OR_AREA,
    SUBSTR(IATAGAP_AGENCIAS.YEAR, 1, 4) ASC;


-- Indicadores de agencias de ese mercado que venden Colombia como destino - Viajeros Agencias

CREATE OR REPLACE VIEW VISTAS.IATAGAP_AGENCIAS_VIAJEROS AS
SELECT IATAGAP_AGENCIAS.TRAVEL_AGENCY_COUNTRY,
    GEOGRAFIA_AGENCIA.COUNTRY_OR_AREA AS PAIS_AGENCIA,
    IATAGAP_AGENCIAS.TRIP_ORIGIN_COUNTRY,
    GEOGRAFIA_DEP.COUNTRY_OR_AREA AS PAIS_DEPARTURE,
    IATAGAP_AGENCIAS.TRIP_DESTINATION_COUNTRY,
    GEOGRAFIA_ARR.COUNTRY_OR_AREA AS PAIS_ARRIVAL,
    IATAGAP_AGENCIAS.YEAR,
    SUBSTR(IATAGAP_AGENCIAS.YEAR, 1, 4) AS YY, 
    CAST(SUM(IATAGAP_AGENCIAS.VALUE) AS BIGINT) AS VIAJEROS_AGENCIAS
FROM IATAGAP.AGENCIAS AS IATAGAP_AGENCIAS
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA_DEP ON IATAGAP_AGENCIAS.TRIP_ORIGIN_COUNTRY = GEOGRAFIA_DEP.NOMBRE_IATA_GAP
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA_ARR ON IATAGAP_AGENCIAS.TRIP_DESTINATION_COUNTRY = GEOGRAFIA_ARR.NOMBRE_IATA_GAP
    LEFT JOIN VISTAS.GEOGRAFIA AS GEOGRAFIA_AGENCIA ON IATAGAP_AGENCIAS.TRAVEL_AGENCY_COUNTRY = GEOGRAFIA_AGENCIA.NOMBRE_IATA_GAP
