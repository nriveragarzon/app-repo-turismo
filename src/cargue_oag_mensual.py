...
file_oag = 'Conectividad_directa_OAG_mes.xlsx'
...
columnas_df = list(df_oag.columns)
...
df_oag_meses_a_cargar = df_oag['TIME_SERIES'].unique()
...
if meses_duplicados:
    errores_criticos = True
    print(f"Error: Los siguientes meses ya existen en la base de datos y no se pueden cargar: {meses_duplicados}")
else:
